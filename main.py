...
def show_page1():
    ...
    unklare_lage_checkbox = ttk.Checkbutton(
        frame, text="Unklare Lage", variable=unklare_lage_checkbox_state
    )
    ...
    checkbox = ttk.Checkbutton(
        frame, text="Sonstige", variable=sonstiges_checkbox_state
    )
    ...
    # textfield.grid(row=5, column=0, padx=10, pady=10)  
