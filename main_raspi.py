...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        reset_button = tk.Button(
            content_frame, text="Reset", command=self.clear_entries, font=("Arial", 20)
        )
...
class RFIDPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.premisson_combobox = ttk.Combobox(
            content_frame,
            text="Berechtigung",
            values=["Admin", "User", "Sani", "Sani+", "Juniorhelfer", "FSJ"],
        )
