...
def test_is_name_in_patient(mock_encrypt, mock_session):
    ...
    mock_session.query.return_value.filter_by.return_value.first.return_value = mock_patient
...
def test_is_uuid_in_patient(mock_session):
    mock_session.query.return_value.filter_by.return_value.first.return_value = mock.Mock()
...
def test_add_patient_new(mock_gen, mock_encrypt, mock_is_name, mock_session):
    ...
    mock_session.query.return_value.filter_by.return_value.first.return_value = mock_protokoll
    mock_patient = mock.Mock(spec=Patient)
